defmodule LocaleadsWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(LocaleadsWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(LocaleadsWeb.Gettext, "errors", msg, opts)
    end
  end
